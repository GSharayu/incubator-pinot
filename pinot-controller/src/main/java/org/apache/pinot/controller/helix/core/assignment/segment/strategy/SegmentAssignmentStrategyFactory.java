  ...
  getSegmentAssignmentStrategy(HelixManager helixManager, TableConfig tableConfig,
    ...
    if (tableConfig.isDimTable()) {
      ...
      Preconditions.checkState(currentTableType == TableType.OFFLINE,
          "DIM table Segment assignment Strategy is only applicable to OfflineTables");
      ...
      if (segmentAssignmentConfigMap != null) {
        ...
        segmentAssignmentConfig = segmentAssignmentConfigMap.get(instancePartitionsType.toString().toUpperCase());
    ...
    if (assignmentStrategy == null) {
      ...
      Preconditions.checkState(instancePartitions != null,
          "Failed to find instance partitions for segment assignment strategy");
