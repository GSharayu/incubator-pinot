...
public class SegmentAssignmentStrategyFactoryTest {
  ...
  public void testSegmentAssignmentStrategyFromTableConfig() {
    ...
    segmentAssignmentConfigMap.put(InstancePartitionsType.OFFLINE.toString(), new SegmentAssignmentConfig(
    ...
    SegmentAssignmentStrategy segmentAssignmentStrategy =
        SegmentAssignmentStrategyFactory.getSegmentAssignmentStrategy(null, tableConfig, instancePartitions,
